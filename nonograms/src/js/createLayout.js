...
console.log('Привет! Клетки игрового поля содержат прозрачный текст решения, который можно увидеть, выделив его. Спасибо за проверку :)');